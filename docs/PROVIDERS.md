...
| `zai-glm` | Claude Code harness via `claude-glm52` | GLM 5.3 | **No** | Strong non-visual worker |
...
`claude` entry point is a GLM 5.3 harness, backed by `bin/claude-glm52`; the
