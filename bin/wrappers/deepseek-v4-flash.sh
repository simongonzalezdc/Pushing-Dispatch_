#!/usr/bin/env bash
# DeepSeek V4 Flash through the Ollama Cloud subscription (same key as kimi-k3-ollama).
...
export CE_TOOL_NAME="deepseek-v4-flash"
export OPENAI_COMPAT_BASE_URL="https://ollama.com/v1"
export OPENAI_COMPAT_PATH="/chat/completions"
export OPENAI_COMPAT_MODEL="${DS_FLASH_MODEL:-deepseek-v4-flash:0731}"
